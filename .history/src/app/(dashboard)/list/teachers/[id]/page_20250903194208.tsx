    ...
    <div className='flex-1 p-4 flex flex-col gap-4 xl:flex-row'> 
        ...
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            <Link className="p-3 rounded-md" href="/">Teacher&apos;s Students</Link>
            <Link className="p-3 rounded-md" href="/">Teacher&apos;s Classes</Link>
            <Link className="p-3 rounded-md" href="/">Teacher&apos;s Lessons</Link>
            <Link className="p-3 rounded-md" href="/">Teacher&apos;s Exams</Link>
            <Link className="p-3 rounded-md" href="/">Teacher&apos;s Assignments</Link>
