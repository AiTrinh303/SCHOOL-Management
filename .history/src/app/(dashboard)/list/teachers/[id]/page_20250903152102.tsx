            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              ...
              <div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
                <div className="">
                 ...
                 <div className="">
                  <Image src="/date.png" alt="Math Teacher" width={14} height={14} className="w-4 h-4"/>
                  <span>March 30, 2025</span>
                </div>
                 <div className="">
                  <Image src="/mail.png" alt="Math Teacher" width={14} height={14} className="w-4 h-4"/>
                  <span>ai.trinh@example.com</span>
                </div>
                 <div className="">
                  <Image src="/phone.png" alt="Math Teacher" width={14} height={14} className="w-4 h-4"/>
                  <span>A+</span>
                </div>
              </div>
            </div>
